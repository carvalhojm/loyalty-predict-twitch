...
def main():
    ...
    parser.add_argument("--table", type=str, help="Table que será processada com o mesmo nome do arquivo")

    now = datetime.datetime.now().strftime("%Y-%m-%d")
    parser.add_argument("--start", type=str, default=now) # --start '2024-03-01'
    parser.add_argument("--stop", type=str, default=now)
    parser.add_argument("--monthly", action='store_true')
    parser.add_argument("--mode", choice=['append','choice'])
...
# python exec_query.py --table life_cycle --start '2024-03-01'
# 
# python exec_query.py --table fs_education --db_origin education-platform --start '2024-03-01'
# 
# python exec_query.py --table fs_transacional --start '2024-03-01'
# 
# python exec_query.py --table fs_life_cycle --db_origin analytics --start '2024-03-01'
# 
# python exec_query.py --table fs_transacional --monthly --start '2024-03-01'